...
public class UserQuery {
    ...
    public static int insert(int userId, String userName, String password) throws SQLException {
    ...
    public static int update(String password, String userName) throws SQLException {
